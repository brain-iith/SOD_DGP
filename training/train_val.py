...
#----------------------------------------------
def train(dataset,split,models_dgp, names_dgp, X, Y, Xs, Ys, Xval, Yval, Y_std, Stest, minibatch_size, lr, max_iterations, iteration_steps,suffix,pred_full_cov):
...
#     print(device_lib.list_local_devices())
    ...
    train(dataset,split,models_dgp, names_dgp, X, Y, Xs, Ys, Xval, Yval, Y_std, args.Stest[0], minibatch_size, args.learning_rate[0], args.max_iter[0], args.iter_steps[0], args.suffix[0],args.predfullcovar)
